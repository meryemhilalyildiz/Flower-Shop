...
const faqs = [
  ...
  },
  {
    ...
    questions: [
      { q: 'Çiçeklerim ne kadar süre taze kalır?', a: 'Doğru bakım ile kesme çiçekler 5-7 gün taze kalır. Saksılı bitkiler çok daha uzun ömürlüdür. 7 gün tazelik garantisi sunuyoruz.' },
      ...
      <div className="bg-gradient-to-br from-brand-50 via-sand-50 to-leaf-50">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="mt-6 text-center">
            ...
            <h1 className="font-display text-4xl lg:text-5xl font-bold text-sand-900">Sıkça Sorulan Sorular</h1>
            <p className="text-sand-600 mt-3 text-lg max-w-xl mx-auto">
              Merak ettiğiniz soruların cevaplarını burada bulamadıysanız, bize ulaşmaktan çekinmeyin.
            </p>
          </div>
        </div>
      </div>
            ...
            .map((item, i) => {
              ...
              return (
                <div key={id} className="card overflow-hidden">
                  ...
                  >
                    <span className="font-semibold text-sand-800">{item.q}</span>
                  ...
                  <div className={`grid transition-all duration-300 ${isOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                    <div className="overflow-hidden">
                      <p className="px-5 pb-5 text-sand-600 leading-relaxed">{item.a}</p>
                    </div>
                  </div>
                </div>
              );
